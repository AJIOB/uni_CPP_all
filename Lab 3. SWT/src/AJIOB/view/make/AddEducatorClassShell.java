...
public class AddEducatorClassShell {
    ...
    private static void init(Shell sh) {
        ...
        okBtn.addListener(SWT.Selection, event -> {
            if (nameText.getText() != "") {
                educator = new Educator(nameText.getText());
            }
